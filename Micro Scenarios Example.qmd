...
An example may be the analysis of the risk-utility trade-offs between different technologies: Do people have different risk or utility dispositions, do people assign different risks and utilities to different technologies, are the risk-utility trade-offs comparable for different technologies and can the risk-utility trade-off be quantified.
...
The strucutre of the data is very similar to the data export from the survey tool Qualtrics. The creation of the synthetic data is documented in the companion notebook in the same folder.
...
The result can be printed as a table (see Table @tbl-topics).
